<x-layout>
    ...
    <div class="container py-4">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="bg-success text-white rounded p-4">
                    ...
                    <p class="mb-0">Buat kursus renang baru dengan mengisi form di bawah ini.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-12">
                <a href="{{ route('admin.kursus') }}" class="btn btn-secondary">
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    <div class="card-header bg-light">
                        <h5 class="mb-0"><i class="bi bi-form"></i> Form Tambah Kursus</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <form action="{{ route('admin.kursus.store') }}" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama_kursus" name="nama_kursus" 
                                               value="{{ old('nama_kursus') }}" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="durasi" class="form-label">Durasi <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="durasi" name="durasi" 
                                               value="{{ old('durasi') }}" placeholder="Contoh: 8 Pertemuan (2 minggu)" required>
                                    </div>
                                    <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <small class="text-muted">Jelaskan detail mengenai kursus ini, target peserta, dan materi yang akan dipelajari.</small>
                            </div>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <button type="submit" class="btn btn-success">
                                    <i class="bi bi-check-circle"></i> Simpan Kursus
                                </button>
                            </div>
                        </form>
                    </div>
